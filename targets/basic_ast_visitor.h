// $Id: basic_ast_visitor.h,v 1.14 2016/05/14 18:45:32 ist179055 Exp $ -*- c++ -*-
...
public:
  ...
  virtual void do_simetric_node(zu::simetric_node * const node, int lvl) = 0;
  virtual void do_position_indicator_node(zu::position_indicator_node * const node, int lvl) = 0;
  virtual void do_memory_reservation_node(zu::memory_reservation_node * const node, int lvl) = 0;
